          ...
          <div className="p-8 md:p-12">
            <div className="flex items-center justify-center mb-4 md:mb-6">
              <div className="bg-primary/10 text-primary font-bold px-3 md:px-4 py-1 md:py-2 rounded-full text-xs sm:text-sm md:text-base flex items-center">
                ...
                SPESIALTILBUD FOR NYETABLERTE BEDRIFTER
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-6 md:gap-8 mb-6 md:mb-8">
              <div className="md:w-2/3">
                <p className="text-base md:text-lg text-gray-700 mb-4 md:mb-6">
                  Få en profesjonell nettside med alt du trenger for å komme i gang, inkludert:
                </p>
              ...
              <div className="md:w-1/3 bg-gray-50 p-4 md:p-6 rounded-lg flex flex-col justify-between">
                <div>
                  <div className="text-2xl font-bold text-gray-900 mb-2">Komplett pakke</div>
                  ...
                  <div className="border-t border-gray-200 my-4 pt-4">
                    ...
                    <div className="flex items-center">
                      <div className="h-4 w-4 rounded-full bg-blue-500 mr-2"></div>
                      <span className="text-gray-700">Teknisk support</span>
                    </div>
                  </div>
                </div>
                <div className="mt-6">
                  <p className="text-sm text-gray-500 mb-2 text-center">Tilbudet er gyldig til 31. august 2025</p>
                </div>
              </div>
            </div>
